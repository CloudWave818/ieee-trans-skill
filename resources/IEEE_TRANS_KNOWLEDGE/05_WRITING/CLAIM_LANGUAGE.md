...
- Match verbs to evidence strength: proposes/designs for method, proves/establishes for formal results, demonstrates/observes for experiments.
- Reserve superior, robust, generalizable, real-time, and safe for directly matched evidence.
