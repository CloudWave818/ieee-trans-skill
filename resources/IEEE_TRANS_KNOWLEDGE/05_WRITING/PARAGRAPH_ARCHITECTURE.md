...
- Give each paragraph one opening function, a core claim or mechanism, evidence/derivation, interpretation, and a forward link.
- Vary paragraph length according to reasoning burden; uniformity is not a quality target.
