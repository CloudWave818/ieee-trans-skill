...
- Move from data to observation, comparison, explanation, mechanism, and scientific implication.
- Use exact numbers selectively to establish scale, not to narrate every cell.
