...
- Reject generic motivation, empty novelty adjectives, repeated signposting, mechanical Firstly/Secondly/Finally, module inventories without rationale, unsupported 'significantly improves', table-value restatement, and empty conclusions.
- Use the corpus as a frequency and counterexample check; rarity alone does not make a phrase wrong.
