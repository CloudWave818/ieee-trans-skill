...
- Route each major claim to at least one direct evidence type and record unmatched claims as gaps.
- Use `CLAIM_EVIDENCE_MATRIX.csv` as a screening map, then verify the actual table, figure, proof, or paragraph.

## Applicability limits

- Keyword co-occurrence is a candidate link, not proof of causal support.
